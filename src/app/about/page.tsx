...
import { FaBook, FaLanguage, FaStickyNote, FaShippingFast, FaUsers } from "react-icons/fa";
import NavBar from "../components/NavBar/NavBar";
...
const About = () => {
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-light-black">
      ...
      <div className="flex flex-col items-center py-16 px-4 w-full max-w-7xl">
        {/* Hero Section */}
        <div className="text-center max-w-3xl mb-20">
          ...
          <p className="text-xl text-silver-light leading-relaxed">
            A digital sanctuary for readers, authors, and curious minds — built with care, one book at a time.
          </p>
        </div>

        {/* Mission Section */}
        <div className="w-full max-w-4xl bg-my-black p-8 rounded-xl border border-silver-dark mb-20">
          <h2 className="text-3xl font-serif font-bold text-secondary mb-4">Our Mission</h2>
          <p className="text-silver-very-light text-lg leading-relaxed">
            We believe knowledge should be accessible to everyone — regardless of language, location, or income. 
            That’s why we offer hundreds of <span className="text-primary-normal font-medium">free books</span>, 
            support for <span className="text-secondary-normal font-medium">4 languages</span> (English, German, Arabic, Russian), 
            and both digital and physical copies — so every reader can find their perfect way to read.
          </p>
        </div>
        ...
        <div className="w-full max-w-4xl bg-my-black p-8 rounded-xl border border-silver-dark mb-20">
          ...
          <p className="text-silver-very-light text-lg leading-relaxed mb-4">
            ...
            <span className="text-primary-normal font-medium"> “What if everyone could carry a world-class library in their pocket?”</span>
          </p>
          <p className="text-silver-very-light text-lg leading-relaxed">
            Today, our library serves readers across continents — but we’re still guided by that same vision. 
            Every feature you use (notes, translations, free books) was built because a real reader asked for it. 
            This isn’t just a store — it’s a community of lifelong learners.
          </p>
        </div>
        ...
        <div className="text-center max-w-2xl">
          ...
          <p className="text-silver-very-light mb-8">
            Whether you’re here to read, write, or simply explore — you belong here.
          </p>
