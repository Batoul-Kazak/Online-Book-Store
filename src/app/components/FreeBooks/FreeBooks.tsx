    ...
    <div className="  p-6 w-full ">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-silver-very-light mb-2">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full p-4 rounded-xl bg-silver-dark text-silver-very-light placeholder-silver-light focus:outline-0 focus:ring-2 focus:ring-primary text-xl"
          />
          {books.length <= 0 && (
            <p className=" justify-center text-secondary p-2">
              It seems like you are offline
            </p>
          )}
        </div>
        <div className=" rounded-xl p-6 mb-8"></div>
