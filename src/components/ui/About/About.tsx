...
const About = () => {
    return (
        <div className="flex flex-col items-center w-full px-4 py-40 max-w-7xl">
            ...
            <div className="w-full max-w-4xl p-8 mb-20 border bg-black/20 rounded-xl border-silver-dark">
                <h2 className="mb-4 font-serif text-2xl font-bold text-secondary">
                    Our Mission
                </h2>
            ...
            <div className="w-full max-w-4xl p-8 mb-20 border rounded-xl border-silver-dark bg-white/10" >
                <h2 className="mb-4 font-serif text-2xl font-bold text-secondary">
                    Our Story
                </h2>
            ...
            <div className="max-w-2xl text-center">
                ...
                <div className="flex flex-col justify-center gap-4 sm:flex-row">
                    <Link
                        href="/free-books"
                        className="px-6 py-3 font-medium text-white rounded-full bg-gradient from-primary to-primary-light"
                    >
                        Discover Free Books
                    </Link>
                    <Link
                        href="/all-books"
                        className="px-6 py-3 font-medium text-white transition-colors border rounded-full bg-gradient-to-r from-primary to-primary-light border-silver-light"
                    >
                        Browse All Books
                    </Link>
                </div>
